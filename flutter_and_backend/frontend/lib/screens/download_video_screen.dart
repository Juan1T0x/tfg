...
class DownloadVideoScreen extends StatefulWidget {
  ...
  @override
  State<DownloadVideoScreen> createState() => _DownloadVideoScreen();
}

class _DownloadVideoScreen extends State<DownloadVideoScreen> {
  ...
  static const int _navIndex = 6; // 0=Actualizar, 1=Consultar, 2=Gallery, 3=Team, 4=Live, 5=Historial, 6=Descargar
    ...
    return Scaffold(
      ...
      body: MainLayout(
        ...
        left: Container(
          ...
          child: const Text(
            'Aquí irá el formulario para descargar vídeos',
